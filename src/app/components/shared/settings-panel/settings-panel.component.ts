...
export class SettingsPanelComponent implements OnInit {
  ...
  changeSidebarTheme(theme) {
    document.querySelector('body').classList.remove('sidebar-light','sidebar-dark');
    document.querySelectorAll('.sidebar-bg-options').forEach( (el) => {
      el.classList.remove('selected');
    })  
    if (theme === "light") {
      document.querySelector('body').classList.add('sidebar-light');
      document.querySelector('#sidebar-light-theme').classList.add('selected');
    } else if (theme === "dark") {
      document.querySelector('body').classList.add('sidebar-dark');
